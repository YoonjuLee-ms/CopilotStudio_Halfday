...
1. **참조 자료(Knowledge)** 탭으로 이동하여 **참조 자료 추가(Add knowledge)** 를 클릭합니다.</br>
   **공무원 휴가제도.pdf** 을 추가합니다.
   ...
   <img src="https://github.com/user-attachments/assets/3fbe2aa9-dd71-4b34-a05c-9eaaccb206c2" width=800/>
...
1. 에이전트를 테스트해 봅시다.
   ...
   이 경우 대답을 하지 않고 연결을 요구할 수도 있습니다. 연결을 진행해 줍니다.

   <img src="https://github.com/user-attachments/assets/0eb24ff8-9657-46b4-9ee1-20a557c22a91" width=800/>


1. 상태가 **진행중** 상태가 됩니다. **준비** 상태가 된 후 에이전트를 테스트해 봅시다.
