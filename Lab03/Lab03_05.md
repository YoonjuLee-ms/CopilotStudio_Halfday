...
3. 이름을 **[아이디] 날씨 요약**으로 정하고, 텍스트 입력을 추가합니다.</br>
    화면 우측의 입력 버튼을 눌러야 입력 추가 인터페이스가 표시됩니다.
    ```
    [아이디] 날씨 요약
    ```

    <img src="https://github.com/user-attachments/assets/a1f0f092-52b1-45d4-8ea4-fb16676e3272" width=600/>

4. 입력변수명을 **날씨정보** 로 지정하고, 아래의 샘플 JSON으로 샘플 데이터를 추가합니다. </br>
    ```
    날씨정보
    ```
    <img src="https://github.com/user-attachments/assets/8b9a9de6-7142-4374-8d3e-926944942fcf" width=400/>
   ...
   ```
    프롬프트에 '날씨정보' 입력변수를 추가합니다.

    <img src="https://github.com/user-attachments/assets/3c02463f-bf1a-4ed7-94a8-a29441c2b5bc" width=350/>
    ...
    <img src="https://github.com/user-attachments/assets/e7647834-3c33-45f0-adc7-c8e7e4cc1e89" width=600/>
