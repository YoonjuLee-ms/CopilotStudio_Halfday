...
3. 이름을 **[아이디] 날씨 요약**으로 정하고, 텍스트 입력을 추가합니다.</br>
    ...
    <img src="https://github.com/user-attachments/assets/254dd155-af4b-4d2d-9d5b-c38f338cf8e5" width=800/>
...
4. 입력변수명을 **날씨정보** 로 지정하고, 아래의 샘플 JSON으로 샘플 데이터를 추가합니다. </br>
   ...
   ```
    ...
    ```
    <img src="https://github.com/user-attachments/assets/2631ccb4-099b-4294-a718-807a42151f39" width=800/>
