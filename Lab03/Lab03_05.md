...
3. 이름을 **[아이디] 날씨 요약**으로 정하고, 텍스트 입력을 추가합니다.</br>
    ...
    <img src="https://github.com/user-attachments/assets/a1f0f092-52b1-45d4-8ea4-fb16676e3272" width=800/>
...
4. 입력변수명을 **날씨정보** 로 지정하고, 아래의 샘플 JSON으로 샘플 데이터를 추가합니다. </br>
   ...
   ```
    ...
    <img src="https://github.com/user-attachments/assets/e7647834-3c33-45f0-adc7-c8e7e4cc1e89" width=800/>
